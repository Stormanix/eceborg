...
g.gd(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.yb(a)},MCa=function(a,b,c){c=void 0===c?null:c;
var d=g.Od("SCRIPT");d.id=a;d.onload=function(){b&&(0,window.setTimeout)(b,0)};
d.onreadystatechange=function(){switch(d.readyState){case "loaded":case "complete":d.onload()}};
c&&d.setAttribute("nonce",c);g.id(d,g.le("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));a=window.document.getElementsByTagName("head")[0]||window.document.body;a.insertBefore(d,a.firstChild);return d},NCa=function(a){a=void 0===a?null:a;
...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;QCa("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",p5,c)}},TCa=function(){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
...
a.zd&&(c=null);var d=(0,g.B)(a.MW,a);c||(c=new g.Qm("//www.google.com/images/cleardot.gif"),Y4(c));cDa(c.toString(),1E4,d)}else z5(2);tDa(a,b)},tDa=function(a,b){a.g=0;
